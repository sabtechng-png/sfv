...
export default function ApprenticeDashboard() {
  ...
  const cards = summary
    ? [
        {
          title: "Pending Witness Requests",
        ...
        },
        {
          ...
          link: "/apprentice/reports",
        },
        {
          title: "Flagged / Rejected",
          value: summary.flaggedExpenses,
          desc: "Expenses marked for re-verification.",
          gradient: "linear-gradient(135deg, #330000, #800000)",
          icon: <Report sx={{ fontSize: 38, color: "#ff5252" }} />,
          link: "/apprentice/reports",
        },
      ]
    : [];

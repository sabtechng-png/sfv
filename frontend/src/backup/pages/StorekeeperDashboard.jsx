...
export default function StorekeeperDashboard() {
  ...
  const menuItems = [
    ...
    { text: "Inventory", icon: <Inventory />, path: "/store/inventory" },
    { text: "Requests", icon: <Assignment />, path: "/store/requests" },
    { text: "Dispatch", icon: <LocalShipping />, path: "/store/dispatch" },
    { text: "Reports", icon: <Assessment />, path: "/store/reports" },
    { text: "Expenses", icon: <Receipt />, path: "/store/expenses" },
  ];
  ...
  const cards = summary
    ? [
        ...
        },
        {
          ...
          desc: "Materials delivered to engineers/staff.",
